...
* Build and run the `Docker Compose` project in Visual Studio.
* Change (if necessary) the token service IP address in the `docker-compose.yaml` file to your local IPV4 address.
...
* [Wendy Wei](https://www.pexels.com/@wendy-wei-387315), [Vishnu R. Nair](https://www.pexels.com/@vishnu-r-nair-426592), [Daria Shevtsova](https://www.pexels.com/@daria-shevtsova), and [Pixabay](https://www.pexels.com/@pixabay) for generously providing stock photography via [Pexels](https://www.pexels.com).
